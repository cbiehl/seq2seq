...
All credit goes to the TensorFlow authors:
...
#     'spa-eng.zip', origin='http://storage.googleapis.com/download.tensorflow.org/data/fra-eng.zip',
#     extract=True
# )

# path_to_file = os.path.dirname(path_to_zip)+"/fra-eng/fra.txt"

bert_path = "./data/bert" #"https://tfhub.dev/google/bert_uncased_L-12_H-768_A-12/1"
path_to_file = "/Users/clemens/Downloads/fra-eng/fra.txt"
...
en_sentence = u"I would like to eat a croissant please."
fr_sentence = u"Je voudrais manger un croissant s'il te plais."
...
translate(u"Je m'apelle BERT et je suis très bon à beaucoup des choses.")
